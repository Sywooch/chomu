        ...
        <div class="footer__subscribe">
            ...
            <form id="subscribes" method="get">
                <div class="footer__subscribe-in">
                    <input type="email" name="subscribe_email" placeholder="Введіть Ваш E-mail" class="inp-error">
            ...
            <div class="popup popup_police" style="display: none;">
                ...
                <div class="popup_police__in">
                    ...
                    <div class="scroller">
                        ...
                        <p>Сайт Chomu.net використовує стандартні технології для збору технічної інформації про вас як відвідувача і може отримувати відомості про ваш IP-адресу, назву вашого браузера і т. д. Відвідуючи сайт Chomu.net, ви даєте згоду на збір і використання цієї інформації сайтом Chomu .net. Дана інформація зберігається у вигляді логів веб-сервера і сервера статистики і використовується для аналізу аудиторії сайту Chomu.net. Особисту інформацію (ім'я, адреса, телефон) Chomu.net не збирає і не використовує.</p>

                        <p>Ви можете налаштувати ваш браузер так, щоб він повідомляв вас або автоматично відхиляв тимчасові файли cookies, і це обмежить збір неособистих даних. Якщо ви відхиляєте тимчасові файли сайту Chomu.net або відмовляєтеся від використання таких тимчасових файлів, ви можете продовжувати відвідувати сайт Chomu.net, але деякі його можливості будуть для вас недоступні.</p>

                        <p>Модифікація Політика конфіденційності: Chomu.net залишає за собою право в будь-який час змінювати, модифікувати або оновлювати Політику Конфіденційності сайту Chomu.net, і ви погоджуєтеся з такими змінами та / або оновленнями.
                        </p>

                    </div>

                </div><!--.popup_police__in-->
            ...
            <div class="popup popup_terms" style="display: none;">
                ...
                <div class="popup_terms__in">
                    ...
                    <div class="scroller">
                        ...
                        <p>2. Всі виключні майнові і немайнові авторські права на інформацію, що розміщується на сайті Chomu.net належать ГО «ВО Успішна країна» та авторам публікацій, якщо в тексті не вказується інше. Під інформацією розуміються всі матеріали, що розміщуються на сайті - статті, новини, інтерв'ю, фото, відео і т. П.</p>
                        <p>3. Інтернет-виданням дозволяється використовувати інформацію, розміщену на сайті Chomu.net, тільки за умови посилання і згадки першоджерела у першому абзаці. Для друкованих видань передрук матеріалів сайту Chomu.net дозволяється при згадці сайту Chomu.net. У теле- і радіосюжетах дозволяється використовувати інформацію, розміщену на сайті Chomu.net, за умови усного посилання на першоджерело. Під використанням інформації мається на увазі будь-яке відтворення, републікування, поширення, переробка, переклад, включення його частин у інші твори й інші способи, передбачені Законом України «Про авторське право і суміжні права».</p>
