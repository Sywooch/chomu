		...
		<div class="news_single__body">
			...
			<div class="news_single__social cf">
				<ul>
					...
					<li class="ok"><a href="javascript:void(0);" class="icon icon-social icon-ok icon-has-text active" onclick="Share.odnoklassniki('http://<?=Yii::$app->request->getServerName();?><?=Url::to(['site/news','url'=> $new->url]);?>','<?= $new->pre_content; ?>')"><span class="icon-inner-text odn-count_<?=$new->id;?>">0</span></a></li>
