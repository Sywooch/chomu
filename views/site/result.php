		...
		<div class="vote_result__list">
			...
			<div class="vote_result__item cf">
				...
				<div class="progress">
					...
					<div class="progress__txt">36<span>%</span></div>
				</div><!--.progress-->
			...
			<div class="vote_result__item cf">
				...
				<div class="progress">
					...
					<div class="progress__txt">3<span>%</span></div>
				</div><!--.progress-->
			...
			<div class="vote_result__item cf">
				...
				<div class="progress">
					...
					<div class="progress__txt">17<span>%</span></div>
				</div><!--.progress-->
			...
			<div class="vote_result__item cf">
				...
				<div class="progress">
					...
					<div class="progress__txt">2<span>%</span></div>
				</div><!--.progress-->
			...
			<div class="vote_result__item cf">
				...
				<div class="progress">
					...
					<div class="progress__txt">100<span>%</span></div>
				</div><!--.progress-->
	...
	<div class="vote_result__in">
		...
		<div class="vote_result__list">
			...
			<div class="vote_result__item cf">
				...
				<h4><span>1.</span> Не вірю у зміни</h4>
			...
			<div class="vote_result__item cf">
				...
				<h4><span>2.</span> Результат відомий заздалегідь</h4>
			...
			<div class="vote_result__item cf">
				...
				<h4><span>3.</span> Не хочу витрачати свій час та сили</h4>
			...
			<div class="vote_result__item cf">
				...
				<h4><span>4.</span> Від мене нічого не залежить</h4>
			...
			<div class="vote_result__item cf">
				...
				<h4><span>5.</span> Важко визначитись із кандидатом</h4>
